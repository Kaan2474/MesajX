...
export default function InputField({ inputFieldHeight, inputFieldWidth, type, placeholder }: Props) {

  return (
    <GestureHandlerRootView style={[styles.inputContainer, {height: inputFieldHeight}, {width: inputFieldWidth}]}>
        <View style={styles.iconContainer}>
          {!! (type === "Nutzername") && <FontAwesome name="user-circle-o" size={18} color="#30C5FF" />}
          {!! (type === "Passwort" || type ==="Passwort bestätigen") && <FontAwesome6 name="lock" size={18} color={"#30C5FF"} />}
          {!! (type === "Vorname" || type ==="Nachname") && <FontAwesome name="user" size={18} color={"#30C5FF"} />}
